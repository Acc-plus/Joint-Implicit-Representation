...
with torch.no_grad():
    # inf_cf_mid(89, 964, 512, 0.3, '89_964_03.npy')
    # inf_cf_mid(1132, 1028, 512, 0.025*17, 'test.npy')
    # inf_cf_mid(1132, 835, 512, 0.025*17, 'test.npy')
    for i in range(26):
        model.set_glyph_idx(i)
        inf_cf_mid(220, 1295,512, 0.025*8,f'rebuttal/x{i}.npy')
    # inf_cfs(23, 262, 5)
    # inf_cf_mid(23, 262, 512, 0, '0.npy')
    # inf_cf_mid(23, 262, 512, 0.25, '1.npy')
    # inf_cf_mid(23, 262, 512, 0.5, '2.npy')
    # inf_cf_mid(23, 262, 512, 0.75, '3.npy')
    # inf_cf_mid(23, 262, 512, 1, '4.npy')
    # inf_cfs(2, 3)
    # inf_cf(1, 512)
    # interpo_peak()
    # interpo_gly(0, 2, 'demo/g1')
    # interpo_gly(0, 14, 'demo/g2')
    # interpo_gly(18, 999, 'demo/g3')
    # interpo_gly(0, 118, 'demo/g4')
    # interpo_gly(32, 56, 'demo/g5')
    # interpo_gly(24, 999, 'demo/g6')
    # interpo_gly(0, 274, 'demo/g0')
    # interpo_gly(141, 153, 'demo/g7')
    # interpo_gly(0, 25, 'demo/g8')
    # model.set_glyph_idx(2)
    # interpo_gly_all(0, 274, 'demo/C0_274')
    # interpo_gly_all(0, 40, 'demo/0_40')
    # interpo_gly_all(0, 201, 'demo/0_201')
    # interpo_whole()
    # interpo_gly_all(0, 26, 'demo/0_26')
    # interpo_gly_all(0, 341)
    # interpo_peak()
    # interpo_gly_all(0, 1076)
    # inf_cfs(107, 113)
    # inf_cf_mid(0, 341, 512, 0)
    # inf_cf_mid(0, 341, 512, 0.25)
    # inf_cf_mid(0, 341, 512, 0.5)
    # inf_cf_mid(0, 341, 512, 0.75)
    # inf_cf_mid(0, 341, 512, 1)
